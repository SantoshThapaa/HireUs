    ...
    return (
        <div>
            ...
            <div className='max-w-4xl mx-auto'>
                <div className='my-10'>
                    <h1 className='font-bold text-2xl'>Your Services/Companies Name</h1>
                    <p className='text-gray-500'>What would you like to give your service/company name? you can change this later.</p>
                </div>
                ...
                <Input
                    type="text"
                    className="my-2"
                    placeholder="Maid or Nursing services..."
